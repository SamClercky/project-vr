...
void prefabs::environmentPrefab(entt::registry & registry, std::shared_ptr<engine::Shader> &prefabShader, std::shared_ptr<engine::Model> &model, std::unique_ptr<btDiscreteDynamicsWorld> &world) {
    ...
    glm::vec3 wall1Size{0.f, wallHeight, 20.f};
    glm::vec3 wall1Pos = position + glm::vec3{15.f, wallHeight/2.f, 0.f};
    ...
    glm::vec3 wall2Size{0.f, wallHeight, 20.f};
    glm::vec3 wall2Pos = position + glm::vec3{-15.f, wallHeight/2.f, 0.f};
    ...
    glm::vec3 wall3Size{30.f, wallHeight, 0.f};
    glm::vec3 wall3Pos = position + glm::vec3{0.f, wallHeight/2.f, 10.f};
